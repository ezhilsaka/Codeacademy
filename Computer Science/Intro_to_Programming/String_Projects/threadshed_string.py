...
for transactions in daily_transactions_split:
  ...
  for item in transactions:
      ...
      strip_transaction = item.strip()
      transaction_clean.append(strip_transaction)
...
for sale in sales:
  ...
  actual_sale = float(sale.strip('$'))
  total_sales = total_sales + actual_sale
...
def color_count (color):
  ...
  for color_in_list in thread_sold_split:
...
for color in colors:
  ...
  total_color = color_count(color)
  print("{} {} color threads are sold today". format(total_color, color))
